...
function custom_random_featured()
{
...
function custom_random_featured_collection()
{
     $collection = get_random_featured_collection();

    if ($collection) {
        $html = get_view()->partial('collections/random-featured.php', array('collection' => $collection));
        release_object($collection);
    } else {
        $html = '<p>' . __('No featured collections are available.') . '</p>';
    }
