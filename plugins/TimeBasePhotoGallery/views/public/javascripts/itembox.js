...
function loadBigItem($clicked){
  ...
  i.onload = function(){
   ...
   var workurl = 'http://api.trove.nla.gov.au/work/' + wk.id + '?key=1sn9tumidclks8vs&encoding=json&callback=?';  
   $.getJSON(workurl, function(data){
      ...
      $('#bigitem .bigworkinfo').append('<h4> View at <a target="new" href="' +  data.work.troveUrl +  '">Trove</a> |  <a target="new" href="' + data.work.identifier[0].value + '"> Wyndham History</a></h4>');
