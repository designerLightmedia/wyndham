...
function buildDecadeHisto(){
  ...
  for (var i = items.length - 1; i >= 0; i--) {
    ...
    workdecade = isNaN(workdecade) ? 0 : workdecade;
    ...
    if (workdecade == 0) {
      ...
      if (typeof decadeclusters[workdecade] != 'undefined') {
...
function buildDecade(label, items){
  ...
  var clustercaption = $('<span class="clustercaption" />').text(typeof workmap[items[0]] == 'undefined' ? '' :workmap[items[0]].title); 
